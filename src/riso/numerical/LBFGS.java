...
//import java.riso.numerical.ExceptionWithIflag;
//import java.riso.numerical.LBFGS;
//import java.riso.numerical.Mcsrch;
...
/*************************************20130910***************************************************/
	public static double gnorm = 0, stp1 = 0, ftol = 0, stp[] = new double[1], ys = 0, yy = 0, sq = 0, yr = 0, beta = 0, xnorm = 0;
	public static int iter = 0, nfun = 0, point = 0, ispt = 0, iypt = 0, maxfev = 0, info[] = new int[1], bound = 0, npt = 0, cp = 0, i = 0, nfev[] = new int[1], inmc = 0, iycn = 0, iscn = 0;
